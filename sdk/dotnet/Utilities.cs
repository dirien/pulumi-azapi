...
namespace Pulumiverse.Azapi
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/dirien/pulumi-azapi";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumiverse.Azapi.version.txt");
    ...
    internal sealed class AzapiResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public AzapiResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
