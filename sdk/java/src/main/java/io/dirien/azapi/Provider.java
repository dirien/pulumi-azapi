...
import io.dirien.azapi.ProviderArgs;
 ...
 * 
 */
@ResourceType(type="pulumi:providers:azapi")
public class Provider extends com.pulumi.resources.ProviderResource {
    ...
    private Output</* @Nullable */ String> defaultLocation;

    public Output<Optional<String>> defaultLocation() {
        return Codegen.optional(this.defaultLocation);
    }
    /**
    ...
    public Provider(String name, ProviderArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azapi", name, args == null ? ProviderArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
